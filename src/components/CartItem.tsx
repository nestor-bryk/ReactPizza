...
import { minusItem, addItem, removeItem, CartItem } from "../redux/slices/cartSlice";
...
const CartItemBlock: React.FC<CartItemProps> = ({id, price, name, imageUrl, count, type, size}) => {
    ...
    const onClickRemove = () => {
        if(window.confirm('Ты действительно хочешь удлить товар?')) {
